    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (reserva.banco < monto) {
                return interaction.reply({ content: '❌ La Reserva Federal no tiene fondos suficientes para este pago.', flags: MessageFlags.Ephemeral });
            }
            ...
            await interaction.reply({ 
                content: `✅ **PAGO APROBADO**: Se han transferido **$${monto.toLocaleString()}** de la Reserva Federal a la cartera de ${empleado}.`,
            });
            ...
            console.error(error);
            interaction.reply({ content: '❌ Error en la base de datos al procesar el pago.', flags: MessageFlags.Ephemeral });
        }
    }
};