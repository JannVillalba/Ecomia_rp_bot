...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            return interaction.reply({ content: "❌ Error al verificar permisos.", flags: [MessageFlags.Ephemeral] });
        }
        ...
        try {
            ...
            console.error(error);
            await interaction.reply({ content: "❌ Error en la base de datos bancaria.", flags: [MessageFlags.Ephemeral] });
        }
    }
};