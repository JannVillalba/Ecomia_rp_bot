...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!personal.admins.includes(interaction.user.id)) {
            return interaction.reply({ content: '<:4666xmark:1444377925930713240> No tienes rango de Jefe/Dueño para aprobar pagos.', flags: MessageFlags.Ephemeral });
        }
        ...
        try {
            ...
            await empleado.send(`<:5526iconbank:1465809664859050249> Tu sueldo por **$${monto.toLocaleString()}** ha sido aprobado por un superior.`).catch(() => {});
